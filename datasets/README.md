...
This directory contains documentation and scripts for acquiring and processing cybersecurity datasets used in the AI-SOC project. This repository is maintained by Tanu Sree Reddy Gavinnolla to support ongoing research in automated threat detection and security operations.
...
Current and upcoming scripts for data management:
...
If you use these datasets in research, please cite the original authors:
...
Cyber Security Professional | Master of Applied Computing Candidate

Tanu Sree Reddy is a dedicated cybersecurity professional with expertise in vulnerability assessment, technical documentation, and risk reporting. With a background in Cyber Security and experience in consulting-style environments, she maintains this project to facilitate advanced security research and compliance tracking.

**Contact Information:**
- Email: gavinno@uwindsor.ca
- LinkedIn: linkedin.com/in/TanusreeReddy

**Need help?** Open an issue on GitHub or contact the project maintainer directly.