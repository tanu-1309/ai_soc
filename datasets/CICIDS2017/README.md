...
The **CICIDS2017** (Canadian Institute for Cybersecurity Intrusion Detection System 2017) dataset is a comprehensive, labeled network intrusion detection dataset created by the University of New Brunswick's Canadian Institute for Cybersecurity. This is the **improved version** with corrected ground-truth labeling, additional features, and removed corrupted entries. This repository serves as a maintained distribution of the improved dataset for research and development in AI-driven Security Operations Centers (SOC).
...
**Tanu Sree Reddy Gavinnolla** is a Cyber Security Professional currently pursuing a Master of Applied Computing. With over 2 years of experience in vulnerability assessment, security documentation, and cyber risk reporting, Tanu maintains this repository to support advanced research in network security and automated threat detection.

**Contact Information:**
- **Email**: gavinno@uwindsor.ca
- **LinkedIn**: linkedin.com/in/TanusreeReddy
- **Affiliation**: California State University, San Bernardino (AI-SOC Project)