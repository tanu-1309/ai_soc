...
This project is maintained by Tanu Sree Reddy Gavinnolla.

Tanu Sree Reddy Gavinnolla is a Cyber Security Professional with expertise in vulnerability assessment, security documentation, and risk reporting. With a background in Cyber Security and ongoing advanced studies in Applied Computing, Tanu focuses on developing automated solutions that enhance SOC efficiency through the integration of SIEM platforms and AI-driven analysis.
