...
For now, all development and maintenance is managed by Tanu Sree Reddy Gavinnolla (gavinno@uwindsor.ca).

---

## About the Maintainer

Tanu Sree Reddy Gavinnolla is a Cyber Security Professional currently pursuing a Master of Applied Computing. With over 2 years of experience in vulnerability assessment, security documentation, and cyber risk reporting, she specializes in bridging technical security analysis with organizational risk management. Her expertise includes Python, PowerShell, and the MITRE ATT&CK framework.
...
**Maintainer:** Tanu Sree Reddy Gavinnolla