...
**Current Maintenance:**
- Tanu Sree Reddy Gavinnolla (gavinno@uwindsor.ca)
- Based on research by Abdul Bari and CSUSB Cybersecurity Research
...
**Project Lead:** Tanu Sree Reddy Gavinnolla
**Email:** gavinno@uwindsor.ca
**LinkedIn:** linkedin.com/in/TanusreeReddy

**About the Developer:**
Tanu Sree Reddy Gavinnolla is a Cyber Security Professional with experience in vulnerability assessment, security documentation, and cyber risk reporting. She specializes in bridging the gap between technical security assessments and stakeholder-ready reporting, with a focus on leveraging AI to automate complex security operations.
